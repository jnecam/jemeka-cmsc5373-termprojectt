...
import {
    uploadProfilePhoto
} from "../controller/storage_controller.js";
      ...
      <tr>
        ...
        <td>
          <input type="text " name="name" value="${accountInfo.name} " disabled required
              placeholder="firstname lastname" pattern"^[A-Za_z][A-Za-z]'|-| ] +">
        </td>
      </tr>
      <tr>
  ...
  `;
    ...
    html += `
      ...
      <container>
        ...
        <div>
          <img id="profile-preview-img" src="${accountInfo.photoURL}" class="rounded-circle" height="250px">
        </div>
        <div>
  ...
  `;
    ...
    profilePhotoUpdate.addEventListener('click', async() => {
        ...
        try {
            ...
            await updateAccountInfo(currentUser.uid, {
                photoURL
            });
